...
public class InformacionHerramienta extends Activity {
		...
		if (isConnected()){
			if (isConnected()){
				new HttpAsyncTaskEliminar()
						.execute("http://contratools-143332.sae1.nitrousbox.com:8080/herramienta/eliminar/"+txt5.getText().toString());
			} else {
	...
	public void editar(View v){
		...
		Intent in = new Intent(InformacionHerramienta.this, EditarHerramienta.class);
